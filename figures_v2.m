...
%             xlabel('Probability stronger animal wins','FontSize',textfontsz)
    ...
    annotation('textbox',[x-.09 y+.08 .05 .04],'String',['(' alphabet(I+1) ')'],'FitBoxToText','on','FontSize',textfontsz,'FontName',fontname,'EdgeColor','none','VerticalAlignment','middle','HorizontalAlignment','left')
end
