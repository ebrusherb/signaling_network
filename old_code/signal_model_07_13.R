...
fight_diff<-seq(0,1,by=.2)
signal_feedback<-seq(0,3,by=.5)
...
library(fields)
image.plot(fight_diff,signal_feedback,A,xlab="Difference in Fighting Ability",ylab="Signaling Feedback",main=paste("Mean Number of Switches, me=",me1,"se=",se1,"sf=",sf))
...
hitting=array(0,c(i,n,n))
decision=array(0,c(i,n,n))
switches=array(0,c(i,n,n))
